...
//
//inline const nonstd::string_view STATIC_RESOURCE = "cinatra_static_resource";
...
struct ci_less {
  ...
  bool operator()(nonstd::string_view s1, nonstd::string_view s2) const {
    return std::lexicographical_compare(s1.begin(), s1.end(),  // source range
                                        s2.begin(), s2.end(),  // dest range
                                        nocase_compare());     // comparison
  }
...
struct sv_char_trait : std::char_traits<T> {
  ...
  static constexpr int compare(nonstd::string_view s1,
                               nonstd::string_view s2) noexcept {
  ...
  static constexpr size_t find(nonstd::string_view str,
    ...
    return nonstd::string_view::npos;
  }
};

inline string_view trim_left(nonstd::string_view v) {
  v.remove_prefix((std::min)(v.find_first_not_of(" "), v.size()));
  return v;
}

inline nonstd::string_view trim_right(nonstd::string_view v) {
  v.remove_suffix((std::min)(v.size() - v.find_last_not_of(" ") - 1, v.size()));
  return v;
}

inline nonstd::string_view trim(nonstd::string_view v) {
  v.remove_prefix((std::min)(v.find_first_not_of(" "), v.size()));
  v.remove_suffix((std::min)(v.size() - v.find_last_not_of(" ") - 1, v.size()));
  return v;
}
...
//inline constexpr nonstd::string_view method_name(http_method mthd) {
//  switch (mthd) {
//    case EduWeb::http_method::DEL:
//      return "DELETE"sv;
//      break;
//    case EduWeb::http_method::GET:
//      return "GET"sv;
//      break;
//    case EduWeb::http_method::HEAD:
//      return "HEAD"sv;
//      break;
//    case EduWeb::http_method::POST:
//      return "POST"sv;
//      break;
//    case EduWeb::http_method::PUT:
//      return "PUT"sv;
//      break;
//    case EduWeb::http_method::CONNECT:
//      return "CONNECT"sv;
//      break;
//    case EduWeb::http_method::OPTIONS:
//      return "OPTIONS"sv;
//      break;
//    case EduWeb::http_method::TRACE:
//      return "TRACE"sv;
//      break;
//    default:
//      return "UNKONWN"sv;
...
inline std::vector<nonstd::string_view> split(nonstd::string_view s,
  ...
  while (end <= nonstd::string_view::npos) {
    output.emplace_back(s.substr(start, end - start));

    if (end == nonstd::string_view::npos) break;
...
//        safe.find(chrval) == nonstd::string_view::npos)
...
//inline const std::string quote(nonstd::string_view str) {
//  std::ostringstream os;
//  return quote_impl(os, str, "/").str();
//}
//
//inline const std::string quote_plus(nonstd::string_view str) {
//  if (str.find(' ') == nonstd::string_view::npos) return quote(str);
//
//  std::ostringstream os;
...
inline bool is_form_url_encode(nonstd::string_view str) {
  return str.find("%") != nonstd::string_view::npos ||
         str.find("+") != nonstd::string_view::npos;
}

inline nonstd::string_view get_extension(nonstd::string_view name) {
...
inline const std::map<nonstd::string_view, nonstd::string_view> get_cookies_map(
    nonstd::string_view cookies_str) {
  std::map<nonstd::string_view, nonstd::string_view> cookies;
